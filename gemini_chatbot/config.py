...
USER_PROMPT_PREFIX: str = os.getenv("USER_PROMPT_PREFIX", "User: ")
AI_RESPONSE_PREFIX: str = os.getenv("AI_RESPONSE_PREFIX", "AI: ")
EXIT_COMMANDS: list[str] = ["exit", "quit", "bye"]

# Display configuration
ENABLE_RICH_FORMATTING: bool = os.getenv("ENABLE_RICH_FORMATTING", "true").lower() == "true" 

# System prompt
SYSTEM_PROMPT: Optional[str] = """You are an expert survey designer, your task is to have a conversation with the user and built a survey.json based on the below schema.
          ...
          "questions": {
            ...
            "items": {
              ...
              "properties": {
                ...
                "type": {
                  "type": "string",
                  "description": "Question type (e.g., RadioButton, CheckBox, etc.)"
                },
                "translatedTexts": {
                  "type": "object",
                  "description": "Translated texts for the question"
                },
                "variables": {
                  "type": "array",
      ...
      "items": {
        ...
        "items": {
          ...
          "properties": {
            ...
            "translatedTexts": {
              "type": "object",
              "description": "Translated texts for the choice"
            },
            "position": {
              "type": "integer",
